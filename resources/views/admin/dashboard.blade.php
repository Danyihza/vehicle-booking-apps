            ...
            <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8  2xl:col-span-2">
                ...
                <div class="flex items-center justify-between mb-4">
                    <div class="flex-shrink-0">
                        <span class="text-2xl sm:text-3xl leading-none font-bold text-gray-900">Pemakaian Kendaraan</span>
                        <h3 class="text-base font-normal text-gray-500">Seluruh Kendaraan</h3>
                    </div>
